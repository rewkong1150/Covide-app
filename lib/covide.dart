...
Covide19 covide19FromJson(String str) => Covide19.fromJson(json.decode(str));

String covide19ToJson(Covide19 data) => json.encode(data.toJson());
...
class Covide19 {
    ...
    factory Covide19.fromJson(Map<String, dynamic> json) => Covide19(
